...
class PropertyFilter(django_filters.FilterSet):
    ...
    property_type = django_filters.CharFilter(
        field_name = "property_name",lookup_expr = "iexact"
    ) 
...
def update_property_api_view(request,slug):
    ...
    if request.method == "PUT":
        data = request.data
        serializer = PropertySerializer(property,data=data,partial=True,many=False)
...
def delete_property_api_view(request,slug):
    ...
    if request.method == "DELETE":
        ...
        if delete_operation:
            ...
            data["error"] = "Property could not be deleted"
